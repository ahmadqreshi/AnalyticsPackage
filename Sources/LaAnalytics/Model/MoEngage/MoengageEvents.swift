...
enum MoEngageEvents: CaseIterable {
    case pageLoaded
...
extension MoEngageEvents {
    var eventTemplate: (eventName: String, analyticsEvent: AnalyticsEvents, eventProperties: [String: Any]?) {
        switch self {
        case .pageLoaded:
            return (EventName.pageLoaded.rawValue, AnalyticsEvents.pageLoaded, [EventProperty.page.rawValue: ""])
        ...
        case .signOut:
            return (EventName.signOut.rawValue, AnalyticsEvents.signOut, [EventProperty.page.rawValue: ""])
        ...
        case .courseVideoEnded:
            return (EventName.courseVideoEnded.rawValue, AnalyticsEvents.courseVideoEnded, [EventProperty.courseTheme.rawValue: "",
                                                                                            ...
                                                                                            EventProperty.page.rawValue: ""])
        case .profileEditButtonClicked:
            return (EventName.profileEditButtonClicked.rawValue, AnalyticsEvents.profileEditButtonClicked, [EventProperty.page.rawValue: ""])
